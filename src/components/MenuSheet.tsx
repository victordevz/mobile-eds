...
function EyeIcon({ size = 24, color = colors.primary, visible = true }: { size?: number; color?: string; visible?: boolean }) {
  if (!visible) {
    return (
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        ...
        />
        <Line x1="1" y1="23" x2="23" y2="1" stroke={color} strokeWidth="2" strokeLinecap="round" />
      </Svg>
    );
  }
  return (
                  ...
                  <View style={styles.balanceCard}>
                    <View style={styles.balanceCardTopRow}>
                      <Pressable onPress={() => setShowBalance(!showBalance)} hitSlop={10}>
                        <EyeIcon size={24} color={colors.primary} visible={showBalance} />
                      </Pressable>
