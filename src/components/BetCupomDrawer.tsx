...
const barStyles = StyleSheet.create({
  ...
  todasBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#023397',
    borderRadius: 10,
    paddingHorizontal: 12,
    paddingVertical: 8,
    gap: 6,
  },
  todasBtnIcon: { fontSize: 14 },
  todasBtnText: { color: '#fff', fontSize: 11, fontWeight: '800' },
  badge: {
    backgroundColor: '#38E67D',
    borderRadius: 10,
    width: 18,
  ...
  badgeText: { color: '#023397', fontSize: 10, fontWeight: '900' },
  plusBtn: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  plusBtnText: { color: '#38E67D', fontSize: 24, fontWeight: '900', lineHeight: 30 },
});
